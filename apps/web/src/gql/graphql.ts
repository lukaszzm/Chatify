...
export type ChatQuery = { __typename?: 'Query', chat?: { __typename?: 'Chat', id: string, title?: string | null, participants: Array<{ __typename?: 'User', id: string, firstName: string, lastName: string }> } | null };
...
export type NoteQuery = { __typename?: 'Query', note?: { __typename?: 'Note', id: string, title: string, content: string, updatedAt: string, isLocked: boolean } | null };
